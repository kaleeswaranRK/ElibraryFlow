 ...
 * Last generated by Orchestration Designer at: 2022-DEC-19  10:29:52 AM
 */
public class CallDisconnect extends com.avaya.sce.runtime.Disconnect {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.OnDisconnect("ivrInfoData", false);
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("exit", ""));
