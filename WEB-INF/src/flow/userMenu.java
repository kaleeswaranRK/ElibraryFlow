 ...
 * Last generated by Orchestration Designer at: 2022-DEC-07  12:36:01 PM
 */
public class userMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("noInputDataUserMenu", 3, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("noMatchDataLangUserMenu", 3, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Exit", "0", true, "exact", "Exist", grammarInfo, true);
		list.add(choice);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		java.util.Collection grammarInfo = null;
		grammarInfo = new java.util.ArrayList();
		choice = new com.avaya.sce.runtime.Choice("newUser", "1", true, "exact", "AgentTranfer", grammarInfo, true);
		choices.add(choice);
		choice = new com.avaya.sce.runtime.Choice("existUser", "2", true, "exact", "Exist", grammarInfo, true);
		choices.add(choice);
		}
		catch (Exception e) {
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
			...
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:userMenuWelcome",
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
				IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("User Menu");
	}
}
