 ...
 * Last generated by Orchestration Designer at: 2022-DEC-07  02:28:31 PM
 */
public class untitledPromptAndCollect2 extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-07  02:28:31 PM
	 */
	public untitledPromptAndCollect2() {
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-07  02:29:36 PM
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("langMenu", ""));

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("singledigit", "1.0"));

		events = new java.util.ArrayList();
		properties = new java.util.ArrayList();

		nbest = mySession.getVariableField(new com.avaya.sce.runtimecommon.VariableName("eLibrary:input")).getIntValue();
		field = new com.avaya.sce.runtime.Field("untitledPromptAndCollect_input1", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CommonAnnounce");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2022-DEC-07  02:29:36 PM
	 */
