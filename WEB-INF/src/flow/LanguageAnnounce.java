 ...
 * executing Last generated by Orchestration Designer at: 2022-DEC-15 02:38:54
 * PM
 */
public class LanguageAnnounce extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("userMenu");
		return submit;
	}
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2023-FEB-09  05:36:33 PM
	 */
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			if ( new com.avaya.sce.runtime.Condition( "condition", "langMenu:value", com.avaya.sce.runtime.Expression.STRING_EQUAL, "1", false, null ).evaluate(p.getSession()) == true ) {
				TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "tamilselect", mySession);
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:TamilSelection",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
				
				
			}
			else if ( new com.avaya.sce.runtime.Condition( "condition", "langMenu:value", com.avaya.sce.runtime.Expression.STRING_EQUAL, "2", false, null ).evaluate(p.getSession()) == true ) {
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:EnglishSelection",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
