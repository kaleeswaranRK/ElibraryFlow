 ...
 * Last generated by Orchestration Designer at: 2022-DEC-07  11:10:09 AM
 */
public class Exit extends com.avaya.sce.runtime.Return {
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.ReportInfo(com.avaya.sce.runtimecommon.IReportInfo.REPORT_TYPE_END_TRANS, com.avaya.sce.runtimecommon.IReportInfo.ALARM_LEVEL_INFO, "CallEnd", "Call End here", ""));
		return(list);
	}
}
