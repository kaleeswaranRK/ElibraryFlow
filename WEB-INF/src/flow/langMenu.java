 ...
 * executing Last generated by Orchestration Designer at: 2022-DEC-07 11:29:20
 * AM
 */
public class langMenu extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2023-FEB-17  10:56:55 AM
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("noInputDataLangMenu", 3, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("noMatchDataLangMenu", 3, true, ""));
		list.add(event);
		return(list);
	}
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Exit", "0", true, "exact", "LanguageAnnounce", grammarInfo, true);
		list.add(choice);
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:languageMenuWelcome",
					com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:languageMenuTamil",
					com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:languageMenuEnglish",
					com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			prompts.add(p);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		java.util.Collection grammarInfo = null;
		grammarInfo = new java.util.ArrayList();
		choice = new com.avaya.sce.runtime.Choice("Tamil", "1", true, "exact", "LanguageAnnounce", grammarInfo, true);
		choices.add(choice);
		choice = new com.avaya.sce.runtime.Choice("English", "2", true, "exact", "LanguageAnnounce", grammarInfo, true);
		choices.add(choice);
	}

	@Override
	public void requestBegin(SCESession mySession) {
		mySession.getVariableField(IProjectVariables.DATA_ELIBRARY, IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION)
				.setValue("Language Menu");
