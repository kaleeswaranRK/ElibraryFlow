 ...
 * Orchestration Designer at: 2023-JAN-03 12:02:15 PM
 */
public class CategoryBooksCheck extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("BookSelectionByCategory-categoryDataCheck");
		next.setDebugId(182);
		return next;
	}
	...
	public void requestBegin(SCESession mySession) {
		try {
			...
			mySession
					.getVariableField(IProjectVariables.DATA_ELIBRARY,
							IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION)
					.setValue("Category books check data node");
			...
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
					"categoryMenuValue : " + categoryMenuValue + "CategoryMenuPageNumber : " + CategoryMenuPageNumber,
					mySession);
			List<String> objectValue = (LinkedList<String>) categoryList.getObjectValue();
			mySession.getVariableField(IProjectVariables.MENU_COMMON, IProjectVariables.MENU_COMMON_FIELD_CATEGORY_NAME)
					.setValue(objectValue.get(((CategoryMenuPageNumber * 6) + categoryMenuValue) - 1));
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
					objectValue.get(((CategoryMenuPageNumber * 6) + categoryMenuValue) - 1), mySession);
			mySession.getVariableField(IProjectVariables.MENU_COMMON, IProjectVariables.MENU_COMMON_FIELD_MENU_PAGE)
			.setValue(0);
		} catch (Exception e) {
