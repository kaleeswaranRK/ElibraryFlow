...
public class CategoryBooksCheck extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("BookSelectionByCategory-BookSelectionMenu");
		next.setDebugId(182);
		return next;
	}
	...
	public void requestBegin(SCESession mySession) {
		try {
			...
			mySession.getVariableField(IProjectVariables.MENU_COMMON,
					IProjectVariables.MENU_COMMON_FIELD_CATEGORY_MENU_LIST).setValue(0);
			;
		} catch (Exception e) {
