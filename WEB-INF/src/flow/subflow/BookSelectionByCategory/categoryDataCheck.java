...
public class categoryDataCheck extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("BookSelectionByCategory-categorySwap");
		next.setDebugId(266);
		return next;
	}
	...
	public void requestBegin(SCESession mySession) {
		try {
			...
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
					"http://172.16.11.43:8082/product/getbooks/" + categoryName.replaceAll(" ", "%20"), mySession);
			List<JSONObject> apiGet = integration.apiGet(
					"http://172.16.11.43:8082/product/getbooks/" + categoryName.replaceAll(" ", "%20"), mySession);
			...
			if (apiGet == null) {
				mySession.getVariableField(IProjectVariables.E_LIBRARY,
						IProjectVariables.E_LIBRARY_FIELD_CATEGORYBOOKS_CHECK).setValue(1);
			} else {
				mySession.getVariableField(IProjectVariables.E_LIBRARY,
						IProjectVariables.E_LIBRARY_FIELD_CATEGORYBOOKS_CHECK).setValue(0);
				TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, String.valueOf(apiGet), mySession);
