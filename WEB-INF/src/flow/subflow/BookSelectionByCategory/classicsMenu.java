...
public class classicsMenu extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2023-JAN-31  11:06:07 AM
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("A Tale Of Two Cities", "1", true, "exact", "BookSelectionByCategory-ClassicsMenuSelectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Dream Of The Red Chamber", "2", true, "exact", "BookSelectionByCategory-ClassicsMenuSelectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("The Catcher in the Rye", "3", true, "exact", "BookSelectionByCategory-ClassicsMenuSelectedBook", grammarInfo, true);
		list.add(choice);
