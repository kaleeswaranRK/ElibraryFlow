...
public class BookSelectionMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("BookSelectionByCategory-NoInputDataPasswordCopy", 3, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("BookSelectionByCategory-NoMatchDataPasswordCopy", 3, true, ""));
		list.add(event);
		return(list);
	}
	...
	public void requestBegin(SCESession mySession) {
		try {
			mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
					IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("Book Selection Menu");
			List<String> booksList =(LinkedList<String>) mySession.getVariableField(IProjectVariables.MENU_COMMON,
					IProjectVariables.MENU_COMMON_FIELD_BOOK_MENU_LIST).getObjectValue();
			List<String> priceList =(LinkedList<String>) mySession.getVariableField(IProjectVariables.MENU_COMMON,
					IProjectVariables.MENU_COMMON_FIELD_PRICE_LIST).getObjectValue();
			List<String> quantityList = (LinkedList<String>)mySession.getVariableField(IProjectVariables.MENU_COMMON,
