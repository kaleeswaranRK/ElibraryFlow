 ...
 * Last generated by Orchestration Designer at: 2023-FEB-08  06:26:59 PM
 */
public class booksMenu extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2023-FEB-09  05:52:20 PM
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("BookSelectionByCategory-NoInputDataPassword", 2, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("BookSelectionByCategory-NoMatchDataPassword", 2, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Exit", "0", true, "exact", "BookSelectionByCategory-booksMenuNext", grammarInfo, true);
		list.add(choice);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		try {
			...
			if (pageCount == 1) {
				...
				choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "BookSelectionByCategory-booksMenu",
						grammarInfo, true);
				choices.add(choice);
			} else {
				if (CategoryMenuPageNumber == 0) {
					for (int i = 0; i < 6; i++) {
						choice = new com.avaya.sce.runtime.Choice(booksList.get(i), String.valueOf(i + 1), true,
								"exact", "BookSelectionByCategory-ReturnTocart", grammarInfo, true);
						choices.add(choice);
					}
					choice = new com.avaya.sce.runtime.Choice("next", "7", true, "exact", "BookSelectionByCategory-booksMenuNext",
							grammarInfo, true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "BookSelectionByCategory-booksMenu",
							grammarInfo, true);
					...
					for (int i = CategoryMenuPageNumber * 6; i < booksList.size(); i++) {
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "booksMenuPageNumber :" + MenuPageNumber
					+ "\npageCount :" + pageCount + "\nCategorySize :" + booksList.size(), mySession);
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:booksMenu",
