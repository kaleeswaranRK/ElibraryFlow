...
public class cartOptionsMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("CartMenuFlow-NoInputcartOptions", 2, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("CartMenuFlow-NoMatchcartOptions", 2, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		java.util.Collection grammarInfo = null;
		grammarInfo = new java.util.ArrayList();
		choice = new com.avaya.sce.runtime.Choice("modifyCart", "1", true, "exact", "CartMenuFlow-cartEditMenu", grammarInfo, true);
		choices.add(choice);
		choice = new com.avaya.sce.runtime.Choice("addtoCart", "2", true, "exact", "CartMenuFlow-returnToSelection", grammarInfo, true);
		choices.add(choice);
		choice = new com.avaya.sce.runtime.Choice("billMenu", "3", true, "exact", "CartMenuFlow-AgentTransfer", grammarInfo, true);
		choices.add(choice);
		}
		catch (Exception e) {
