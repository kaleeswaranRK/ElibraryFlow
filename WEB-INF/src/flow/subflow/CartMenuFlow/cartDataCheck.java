 ...
 */
public class cartDataCheck extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("CartMenuFlow-cartSwap");
		next.setDebugId(257);
		return next;
	}
	...
	public void requestBegin(SCESession mySession) {
		try {
			mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
					IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("cart data check data node");
			 mySession
			...
			String categoryName = mySession
					...
					.getStringValue();
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "http://172.16.11.43:8082/cart/cartview/" + userId,
					mySession);
			List<JSONObject> apiGet = integration.apiGet("http://172.16.11.43:8082/cart/cartview/" + userId,mySession);
			if (apiGet==null) {
				mySession.getVariableField(IProjectVariables.E_LIBRARY,
						IProjectVariables.E_LIBRARY_FIELD_CART_ITEM_CHECK).setValue(1);
			}
			else {
				mySession.getVariableField(IProjectVariables.E_LIBRARY,
						IProjectVariables.E_LIBRARY_FIELD_CART_ITEM_CHECK).setValue(0);
				List<String> books= new LinkedList<String>();
				List<String> quantities= new LinkedList<String>();
