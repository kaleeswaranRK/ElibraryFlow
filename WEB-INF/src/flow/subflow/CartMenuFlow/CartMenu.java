...
public class CartMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("ExistCart", "1", true, "exact", "CartMenuFlow-cartData", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("AddCart", "0", true, "exact", "CartMenuFlow-returnToSelection", grammarInfo, true);
		list.add(choice);
