 ...
 * Last generated by Orchestration Designer at: 2023-FEB-01  05:48:27 PM
 */
public class removeProductAnnounce extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CartMenuFlow-CartMenu");
		return submit;
	}
	/**
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			String postAnnounce = mySession.getVariableField(IProjectVariables.MENU_COMMON,
					IProjectVariables.MENU_COMMON_FIELD_API_POST).getStringValue();
			if ("true".equalsIgnoreCase(postAnnounce) ){
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:productRemovedSuccess",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			} else {
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:productRemovedFailiure",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			}
			prompts.add(p);
		} catch (Exception e) {
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
				IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("remove product Announce");
	}
}
