 ...
 * Last generated by Orchestration Designer at: 2023-FEB-01  05:59:01 PM
 */
public class cartEditAnnounce extends com.avaya.sce.runtime.Form {
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			if ("true".equalsIgnoreCase(postAnnounce) ){
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:cartEditSuccess",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			} else {
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:cartEditFailiure",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			}
			prompts.add(p);
		} catch (Exception e) {
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
				IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("cart edit announce");
	}
}
