 ...
 */
public class cartItemsMenuNext extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("CartMenuFlow-cartItemsMenu", "Default");
		next.setDebugId(209);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
				IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("cart items Menu next data node");
