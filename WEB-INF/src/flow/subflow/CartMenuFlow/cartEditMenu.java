...
public class cartEditMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("CartMenuFlow-NoInputcartEdit", 2, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("CartMenuFlow-NoMatchcartEdit", 2, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("addCount", "1", true, "exact", "CartMenuFlow-cartItemsMenu", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("reduceCount", "2", true, "exact", "CartMenuFlow-cartItemsMenu", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("removeProduct", "3", true, "exact", "CartMenuFlow-removeProduct", grammarInfo, true);
		list.add(choice);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("reduceCount", "2", true, "exact", "CartMenuFlow-cartItemsMenu", grammarInfo, true);
		choices.add(choice);
		choice = new com.avaya.sce.runtime.Choice("removeProduct", "3", true, "exact", "CartMenuFlow-cartItemsMenu", grammarInfo, true);
		choices.add(choice);
		}
		catch (Exception e) {
