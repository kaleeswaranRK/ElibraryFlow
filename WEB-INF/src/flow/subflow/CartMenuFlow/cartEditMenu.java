 ...
 * Last generated by Orchestration Designer at: 2023-FEB-01  05:42:48 PM
 */
public class cartEditMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("CartMenuFlow-NoInputcartEdit", 3, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("CartMenuFlow-NoMatchcartEdit", 3, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Exit", "0", true, "exact", "CartMenuFlow-ReturnToExit", grammarInfo, true);
		list.add(choice);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		java.util.Collection grammarInfo = null;
		grammarInfo = new java.util.ArrayList();
		choice = new com.avaya.sce.runtime.Choice("addCount", "1", true, "exact", "CartMenuFlow-productModifySwap", grammarInfo, true);
		choices.add(choice);
		choice = new com.avaya.sce.runtime.Choice("reduceCount", "2", true, "exact", "CartMenuFlow-productModifySwap", grammarInfo, true);
		choices.add(choice);
		choice = new com.avaya.sce.runtime.Choice("removeProduct", "3", true, "exact", "CartMenuFlow-productModifySwap", grammarInfo, true);
		choices.add(choice);
		}
		catch (Exception e) {
		...
		public void updatePrompts(Collection prompts, SCESession mySession) {
			...
			try {
				...
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:CartEditMenu",
		...
		public void requestBegin(SCESession mySession) {
			...
			mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
					IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("cart edit Menu");
		}
}
