 ...
 * Last generated by Orchestration Designer at: 2023-FEB-01  05:57:04 PM
 */
public class cartProductCount extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("CartMenuFlow-NoInputcartEditCopy", 3, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("CartMenuFlow-NoMatchcartEditCopy", 3, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("ProductCount", "1.0"));

		events = new java.util.ArrayList();
		properties = new java.util.ArrayList();

		nbest = 1;
		field = new com.avaya.sce.runtime.Field("cartProductCount", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CartMenuFlow-cartModifyCountData");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2023-FEB-17  10:56:53 AM
	 */
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			p.setTimeout(1, 8000);
			p.setBargin(1, false);
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR,"http://172.16.12.123:8080/Audiopromts/Elibrary/welcome.wav", mySession);
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
					"menuCommon:cartProductCount",
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
				IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("cart product count prompt and collect");
	}
}
