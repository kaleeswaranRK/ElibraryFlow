 ...
 * Last generated by Orchestration Designer at: 2022-DEC-08  11:16:39 AM
 */
public class authorMenu extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2023-JAN-25  04:23:29 PM
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ExistUser-NoInputDataAuthorMenu", 2, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ExistUser-NoMatchDataAuthorMenu", 2, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("JK Rowling", "1", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Rider Haggard", "2", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Paulo Coelho", "3", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Charles Dickens", "4", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Chao Xueqin", "5", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("JD Salinger", "6", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("authorMenu", ""));
