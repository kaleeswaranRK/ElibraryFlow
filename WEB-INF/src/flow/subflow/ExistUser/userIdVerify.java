 ...
 * Orchestration Designer at: 2022-DEC-27 12:11:27 PM
 */
public class userIdVerify extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2023-JAN-25  02:07:04 PM
	 */
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("ExistUser-userIdCheck", "Default");
		next.setDebugId(890);
		return next;
	}
	...
	public void requestBegin(SCESession mySession) {
			...
			String Query ="EXEC KALEESWARAN_FIND_USER @id ="+userId.getStringValue();
			IVariableField usercheck = mySession.getVariableField(IProjectVariables.E_LIBRARY,
					IProjectVariables.E_LIBRARY_FIELD_USERCHECK);
			DBCBConnect database=new DBCBConnect();
			boolean execute = database.executeQuery(Query, mySession);
			if (execute) {
				TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "execute="+execute, mySession);
				usercheck.setValue(1);
			} else {
				usercheck.setValue(0);
			}
			}
			catch (Exception e) {
