...
public class selectAuthorReturn extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("bookMenu", "1", true, "exact", "ExistUser-bookSelectionByAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("back", "0", true, "exact", "ExistUser-authorMenu", grammarInfo, true);
		list.add(choice);
