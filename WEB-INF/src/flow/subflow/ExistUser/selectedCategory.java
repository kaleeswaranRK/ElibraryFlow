 ...
 * executing Last generated by Orchestration Designer at: 2022-DEC-08 05:10:07
 * PM
 */
public class selectedCategory extends com.avaya.sce.runtime.Form {
	 ...
	 * by Orchestration Designer at: 2023-FEB-08 04:14:45 PM
	 * 
	 ...
	 * Orchestration Designer at: 2023-FEB-08 04:14:45 PM
	 * 
	...
	/**
	 * Builds the list of fields for the form. This list is built by the code
	 * generator based on items in the call flow editor. This method should not be
	 * manually edited as changes may be overwritten by the code generator. <br>
	 * To update the fields for the form, override public void
	 * updateFields(Collection fields, com.avaya.sce.runtimecommon.SCESession
	 * mySession) Last generated by Orchestration Designer at: 2023-FEB-08 04:14:45
	 * PM
	 */
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("selectBookEnd", ""));

		return (list);
	}

	/**
	 * Returns the submit item that identifies the next form to transition to. This
	 * method is generated automatically by the code generator and should not be
	 * manually edited. Manual edits may be overwritten by the code generator. Last
	 * generated by Orchestration Designer at: 2023-FEB-08 04:14:45 PM
	 */
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ExistUser-bookSelectionByCategory");
		return submit;
	}

	/**
	 * Returns the record item for the form. This method is generated automatically
	 * by the code generator and should not be manually edited. Manual edits may be
	 * overwritten by the code generator. Last generated by Orchestration Designer
	 * at: 2023-FEB-08 04:14:45 PM
	 */
	...
	/**
	 * Returns the transfer item for the form. This method is generated
	 * automatically by the code generator and should not be manually edited. Manual
	 * edits may be overwritten by the code generator. Last generated by
	 * Orchestration Designer at: 2023-FEB-08 04:14:45 PM
	 */
	...
	/**
	 * Returns a Throw object that will throw an event at runtime if set. This
	 * method is generated automatically by the code generator and should not be
	 * manually edited. Manual edits may be overwritten by the code generator. Last
	 * generated by Orchestration Designer at: 2023-FEB-08 04:14:45 PM
	 */
	 ...
	 *         Designer at: 2023-FEB-08 04:14:45 PM
	 */
	...
	/**
	 * Returns a collection of platform objects, or extensions to VXML. These
	 * objects result in the generation of the VXML object tag that the VXML
	 * platform attempts to use to load the runtime library that implements the
	 * extension.
	 * 
	 ...
	 * Last generated by Orchestration Designer at: 2023-FEB-08 04:14:45 PM
	 */
	...
	/**
	 * Builds the initial element for the form. This method is built by the code
	 * generator based on items in the call flow editor. This method should not be
	 * manually edited as changes may be overwritten by the code generator. <br>
	 * Last generated by Orchestration Designer at: 2023-FEB-08 04:14:45 PM
	 */
	...
	/**
	 * Builds the grammar elements for the form. This method is built by the code
	 * generator based on items in the call flow editor. This method should not be
	 * manually edited as changes may be overwritten by the code generator. <br>
	 * Last generated by Orchestration Designer at: 2023-FEB-08 04:14:45 PM
	 */
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			int CategoryMenuPageNumber = mySession
					...
					.getIntValue();
			int CategoryMenuvalue = mySession
					.getVariableField(IProjectVariables.CATEGORY_MENU, IProjectVariables.CATEGORY_MENU_FIELD_VALUE)
					.getIntValue();
			int i = (CategoryMenuPageNumber * 6) + CategoryMenuvalue;
