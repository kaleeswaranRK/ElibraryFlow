 ...
 * executing Last generated by Orchestration Designer at: 2023-JAN-05 11:16:43
 * AM
 */
public class BookAddedAnnouncement extends com.avaya.sce.runtime.Form {

	// {{START:CLASS:FIELDS
	// }}END:CLASS:FIELDS

	/**
	 * Default constructor Last generated by Orchestration Designer at: 2023-JAN-05
	 * 11:16:43 AM
	 */
	public BookAddedAnnouncement() {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ExistUser-CartFlow");
		return submit;
	}
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			int postAnnounce = mySession.getVariableField(IProjectVariables.MENU_COMMON,
					IProjectVariables.MENU_COMMON_FIELD_API_POST).getIntValue();
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "postAnnounce value : "+postAnnounce, mySession);
			if (postAnnounce==1){
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("UserDetails:notAdded",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			} else {
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("UserDetails:addedSuccess",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			}
			prompts.add(p);
		} catch (Exception e) {
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
				IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("book Added Announcement");
	}
}
