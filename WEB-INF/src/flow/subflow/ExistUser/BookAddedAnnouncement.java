...
public class BookAddedAnnouncement extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		___tempPromptName = mySession.getVariableField(new com.avaya.sce.runtimecommon.VariableName("AudioPath:AdventureMenu")).getStringValue();
		validateResource(mySession, com.avaya.sce.runtime.internal.PromptFinder.TYPE, ___tempPromptName, "Invalid Prompt Name in variable [AudioPath:AdventureMenu]");
		list.add(new com.avaya.sce.runtime.PromptRefInfo(___tempPromptName, ""));
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2023-FEB-09  06:02:18 PM
	 */
