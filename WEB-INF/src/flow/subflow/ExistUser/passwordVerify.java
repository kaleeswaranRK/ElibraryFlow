...
public class passwordVerify extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		try {
			...
			String sha256 = HashingClass.getSha256(userpass.getStringValue());
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, sha256, mySession);
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "http://172.16.11.17:8082/user/verify/" + userId.getIntValue(), mySession);
			String apiGet = integration.apiGetPassword("http://172.16.11.17:8082/user/verify/" + userId.getIntValue());
