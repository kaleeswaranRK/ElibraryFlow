			...
			if (pageCount==1) {
				for (int i = 0; i < categories.size(); i++) {
					choice = new com.avaya.sce.runtime.Choice(categories.get(i), String.valueOf(i + 1), true, "exact",
							"selectedCategory", grammarInfo, true);
					choices.add(choice);
				}
				choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "CategoryMenu", grammarInfo,
						true);
				choices.add(choice);
			}
			else{
				if (CategoryMenuPageNumber == 0) {
					for (int i = 0; i < 6; i++) {
						choice = new com.avaya.sce.runtime.Choice(categories.get(i), String.valueOf(i + 1), true,
								"exact", "selectedCategory", grammarInfo, true);
						choices.add(choice);
					}
					choice = new com.avaya.sce.runtime.Choice("next", "7", true, "exact", "CategoryMenuNext", grammarInfo,
							true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "CategoryMenu", grammarInfo,
							true);
					...
					for (int i = CategoryMenuPageNumber*6; i < categories.size(); i++) {
						choice = new com.avaya.sce.runtime.Choice(categories.get(i), String.valueOf(i - ((CategoryMenuPageNumber*6)-1)),
								true, "exact", "selectedCategory", grammarInfo, true);
						choices.add(choice);
					}
					choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "CategoryMenu", grammarInfo,
							true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("previous", "8", true, "exact", "CategoryMenuNext",
							grammarInfo, true);
					choices.add(choice);
				}
				else {
...
//	}
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
			...
			if (pageCount==1) {
				for (int i = 0; i < categories.size(); i++) {
					p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
							"AudioPath:" + categories.get(i).replaceAll(" ", ""),
							com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
					TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "Category "+"AudioPath:" + categories.get(i).replaceAll(" ", ""), mySession);
				}
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
						"menuCommon:Select9",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			...
			prompts.add(p);
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "prompt Size :"+prompts.size(), mySession);
