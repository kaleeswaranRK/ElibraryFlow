...
public class CategoryMenu extends com.avaya.sce.runtime.Menu  {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ExistUser-NoInputDataBookMenu", 3, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ExistUser-NoMatchDataBookMenu", 3, true, ""));
		list.add(event);
		return(list);
	}
	...
	public void requestBegin(SCESession mySession) {
		try {
			...
			mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
					IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("Category Menu");
			List<String> categoryList = (LinkedList<String>)mySession.getVariableField(IProjectVariables.MENU_COMMON,
					IProjectVariables.MENU_COMMON_FIELD_CATEGORY_MENU_LIST).getObjectValue();
		...
		try {
			...
			if (pageCount == 1) {
				...
				if (CategoryMenuPageNumber == 0) {
					...
					for (int i = CategoryMenuPageNumber * 6; i < categories.size(); i++) {
						setValue.projectVariableSetValue(mySession, "http://172.16.11.43:8090/Audioprompts/Elibrary/"
