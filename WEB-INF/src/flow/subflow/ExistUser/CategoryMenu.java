 ...
 * executing Last generated by Orchestration Designer at: 2022-DEC-07 06:12:48
 * PM
 */
public class CategoryMenu extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2023-FEB-08  06:05:19 PM
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ExistUser-NoInputDataBookMenu", 2, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ExistUser-NoMatchDataBookMenu", 2, true, ""));
		list.add(event);
		return(list);
	}
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Exit", "0", true, "exact", "ExistUser-bookSelectionByCategory", grammarInfo, true);
		list.add(choice);
	...
	public void requestBegin(SCESession mySession) {
		try {
			...
			for (int i = 0; i < apiGet.size(); i++) {
				categories.add(apiGet.get(i).get("categoryName").toString());
				System.out.println(apiGet.get(i).get("categoryName").toString());
			}
			IVariableField categoryList = mySession
					.getVariableField(IProjectVariables.MENU_COMMON, IProjectVariables.MENU_COMMON_FIELD_CATEGORY_MENU_LIST);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		try {
			...
			if (categories.size() % 6 == 0) {
				pageCount = categories.size() / 6;
			} else {
				pageCount = (categories.size() / 6) + 1;
			}
			if (pageCount==1) {
				for (int i = 0; i < categories.size(); i++) {
					choice = new com.avaya.sce.runtime.Choice(categories.get(i), String.valueOf(i + 1), true, "exact",
							"ExistUser-bookSelectionByCategory", grammarInfo, true);
					choices.add(choice);
				}
				choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "ExistUser-CategoryMenu", grammarInfo,
						true);
				choices.add(choice);
			}
			else{
				if (CategoryMenuPageNumber == 0) {
					for (int i = 0; i < 6; i++) {
						choice = new com.avaya.sce.runtime.Choice(categories.get(i), String.valueOf(i + 1), true,
								"exact", "ExistUser-bookSelectionByCategory", grammarInfo, true);
						choices.add(choice);
					}
					choice = new com.avaya.sce.runtime.Choice("next", "7", true, "exact", "ExistUser-CategoryMenuNext", grammarInfo,
							true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "ExistUser-CategoryMenu", grammarInfo,
							true);
					...
					for (int i = CategoryMenuPageNumber*6; i < categories.size(); i++) {
						choice = new com.avaya.sce.runtime.Choice(categories.get(i), String.valueOf(i - ((CategoryMenuPageNumber*6)-1)),
								true, "exact", "ExistUser-bookSelectionByCategory", grammarInfo, true);
						choices.add(choice);
					}
					choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "ExistUser-CategoryMenu", grammarInfo,
							true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("previous", "8", true, "exact", "ExistUser-CategoryMenuNext",
							grammarInfo, true);
					choices.add(choice);
				}
				else {
...
//			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:CategoryMenu",
//					com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
//			for (int i = 0; i < categories.size(); i++) {
//				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
//						"AudioPath:" + categories.get(i).replaceAll(" ", ""),
//						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
//				System.out.println(categories.get(i).replaceAll(" ", ""));
//				System.out.println("added" + i);
//			}
//			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("menuCommon:nineSelect",
//					com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
//			prompts.add(p);
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
			...
			int CategoryMenuPageNumber = mySession
					.getVariableField(IProjectVariables.MENU_COMMON, IProjectVariables.MENU_COMMON_FIELD_MENU_PAGE)
					.getIntValue();
			IVariableField em = mySession
					.getVariableField(IProjectVariables.MENU_COMMON, IProjectVariables.MENU_COMMON_FIELD_NEW_AUDIO_PATH);
			int pageCount =0;
			if (categories.size() % 6 == 0) {
				pageCount = categories.size() / 6;
			} else {
			...
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "CategoryMenuPageNumber :"+CategoryMenuPageNumber+"\npageCount :"+pageCount+"\nCategorySize :"+categories.size(), mySession);
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:CategoryMenu",
					com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			if (pageCount==1) {
				for (int i = 0; i < categories.size(); i++) {
					String url="http://172.16.11.17:8090/AudioPrompts/Elibrary/Adventurestories.wav";
					TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,url, mySession);
					em.setValue(url);  
					p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
							"menuCommon:menuOption"+(i+1),
							com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
					p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
							"menuCommon:newAudioPath",
							com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
					TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, em.getStringValue(), mySession);
				}
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
						"menuCommon:menuOption9",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
				...
				if (CategoryMenuPageNumber == 0) {
					...
					for (int i = CategoryMenuPageNumber*6; i < categories.size(); i++) {
						p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
								"menuCommon:menuOption"+(i - ((CategoryMenuPageNumber*6)-1)),
								com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
						p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
								"AudioPath:" + categories.get(i).replaceAll(" ", ""),
								com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
