...
public class CategoryMenu extends com.avaya.sce.runtime.Menu  {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Exit", "0", true, "exact", "ExistUser-CategoryMenuNext", grammarInfo, true);
	...
	public void requestBegin(SCESession mySession) {
		try {
			...
			IVariableField categoryList = mySession.getVariableField(IProjectVariables.MENU_COMMON,
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		try {
			...
			if (pageCount == 1) {
				...
				choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "ExistUser-CategoryMenu",
						grammarInfo, true);
				choices.add(choice);
			} else {
				if (CategoryMenuPageNumber == 0) {
					...
					choice = new com.avaya.sce.runtime.Choice("next", "7", true, "exact", "ExistUser-CategoryMenuNext",
							grammarInfo, true);
					choices.add(choice);
					choice = new com.avaya.sce.runtime.Choice("Repeat", "9", true, "exact", "ExistUser-CategoryMenu",
							grammarInfo, true);
					...
					for (int i = CategoryMenuPageNumber * 6; i < categories.size(); i++) {
						choice = new com.avaya.sce.runtime.Choice(categories.get(i),
					...
					choice = new com.avaya.sce.runtime.Choice("previous", "8", true, "exact",
							"ExistUser-CategoryMenuNext", grammarInfo, true);
					choices.add(choice);
				} else {
			...
			if (pageCount == 1) {
				for (int i = 0; i < categories.size(); i++) {
					...
					setValue.projectVariableSetValue(mySession, "http://172.16.11.17:8090/AudioPrompts/Elibrary/"
							+ categories.get(i).replaceAll(" ", "") + ".wav", i + 1);
				...
				if (CategoryMenuPageNumber == 0) {
					...
					for (int i = CategoryMenuPageNumber * 6; i < categories.size(); i++) {
						setValue.projectVariableSetValue(mySession, "http://172.16.11.17:8090/AudioPrompts/Elibrary/"
								+ categories.get(i).replaceAll(" ", "") + ".wav", (i - ((CategoryMenuPageNumber * 6) - 1)));
						p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
								"menuCommon:menuOption" + (i - ((CategoryMenuPageNumber * 6) - 1)),
								com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
						p.add(1, new com.avaya.sce.runtime.PhraseVariableElement(
								"menuCommon:menuOptionValue"+ (i - ((CategoryMenuPageNumber * 6) - 1)),
								com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
					}
					p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("menuCommon:menuOption9",
							com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
