 ...
 * Last generated by Orchestration Designer at: 2022-DEC-23  12:17:26 PM
 */
public class AgentTransferAnnounce extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("agentConnect", ""));
		list.add(new com.avaya.sce.runtime.PromptRefInfo("callTranferComplete", ""));
