 ...
 * executing Last generated by Orchestration Designer at: 2022-DEC-23 12:17:26
 * PM
 */
public class AgentTransferAnnounce extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2023-FEB-17  10:56:54 AM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("agentTransfer-returnToMain");
		return submit;
	}
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2023-FEB-17  10:56:54 AM
	 */
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.DATA_ELIBRARY, IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION)
				.setValue("Agent transfer Announcement");
	}
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			p.setTimeout(1, 8000);
			p.setBargin(1, false);
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "http://172.16.11.43:8080/Audiopromts/Elibrary/AgentConnect.wav",
					mySession);
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:AgentConnect",
					com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:AgentMusic",
					com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			prompts.add(p);
