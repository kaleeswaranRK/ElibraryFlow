 ...
 * Last generated by Orchestration Designer at: 2022-DEC-07  01:05:24 PM
 */
public class existUserAnnounce extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2023-FEB-13  11:43:29 AM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("AgentTranfer");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2023-FEB-13  11:43:29 AM
	 */
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		try {
			...
			String userMenuValue = mySession.getVariableField(IProjectVariables.USER_MENU,
					IProjectVariables.USER_ID_FIELD_VALUE).getStringValue();
			if ("1".equals(userMenuValue)) {
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:userNew",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));					
			}
			else if ("2".equals(userMenuValue) ) {
				p.add(1, new com.avaya.sce.runtime.PhraseVariableElement("AudioPath:existUserAnnounce",
						com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL, false));
			}	
			prompts.add(p);
