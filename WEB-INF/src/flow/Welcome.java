...
public class Welcome extends com.avaya.sce.runtime.Form {
	...
	public void requestBegin(SCESession mySession) {
		try {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "welcome Announce Entry", mySession);
			...
			mySession.getVariableField(IProjectVariables.DATA_ELIBRARY,
					IProjectVariables.DATA_ELIBRARY_FIELD_EXIT_LOCATION).setValue("Welcome Announce");
			...
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "welcome Announce Exit", mySession);
