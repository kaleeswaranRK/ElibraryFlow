 ...
 * Last generated by Orchestration Designer at: 2022-DEC-08  06:04:06 PM
 */
public class userNameIssue extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-08  06:59:00 PM
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event("nomatchUserId", (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ExistUser-returnToElibrary", 2, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ExistUser-userEvent");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2022-DEC-08  06:59:00 PM
	 */
