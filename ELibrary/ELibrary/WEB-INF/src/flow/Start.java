...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.UNTITLED_MENU_2_FIELD_CONFIDENCE,
			IProjectVariables.UNTITLED_MENU_2_FIELD_INPUTMODE,
			IProjectVariables.UNTITLED_MENU_2_FIELD_INTERPRETATION,
			IProjectVariables.UNTITLED_MENU_2_FIELD_NOINPUTCOUNT,
			IProjectVariables.UNTITLED_MENU_2_FIELD_NOMATCHCOUNT,
			IProjectVariables.UNTITLED_MENU_2_FIELD_UTTERANCE,
			IProjectVariables.UNTITLED_MENU_2_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.UNTITLED_MENU_2, variableFields, null, session, false, false );
		...
		variableFields = new String[] {
			IProjectVariables.CATEGORY_MENU_RETURN_FIELD_CONFIDENCE,
			IProjectVariables.CATEGORY_MENU_RETURN_FIELD_INPUTMODE,
			IProjectVariables.CATEGORY_MENU_RETURN_FIELD_INTERPRETATION,
			IProjectVariables.CATEGORY_MENU_RETURN_FIELD_NOINPUTCOUNT,
			IProjectVariables.CATEGORY_MENU_RETURN_FIELD_NOMATCHCOUNT,
			IProjectVariables.CATEGORY_MENU_RETURN_FIELD_UTTERANCE,
			IProjectVariables.CATEGORY_MENU_RETURN_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CATEGORY_MENU_RETURN, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.JKROWLING_MENU_FIELD_CONFIDENCE,
			IProjectVariables.JKROWLING_MENU_FIELD_INPUTMODE,
			IProjectVariables.JKROWLING_MENU_FIELD_INTERPRETATION,
			IProjectVariables.JKROWLING_MENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.JKROWLING_MENU_FIELD_NOMATCHCOUNT,
			IProjectVariables.JKROWLING_MENU_FIELD_UTTERANCE,
			IProjectVariables.JKROWLING_MENU_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.JKROWLING_MENU, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.CATEGORY_SELECTION_RETURN_FIELD_CONFIDENCE,
			IProjectVariables.CATEGORY_SELECTION_RETURN_FIELD_INPUTMODE,
			IProjectVariables.CATEGORY_SELECTION_RETURN_FIELD_INTERPRETATION,
			IProjectVariables.CATEGORY_SELECTION_RETURN_FIELD_NOINPUTCOUNT,
			IProjectVariables.CATEGORY_SELECTION_RETURN_FIELD_NOMATCHCOUNT,
			IProjectVariables.CATEGORY_SELECTION_RETURN_FIELD_UTTERANCE,
			IProjectVariables.CATEGORY_SELECTION_RETURN_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CATEGORY_SELECTION_RETURN, variableFields, null, session, false, false );
		session.putVariable(variable);
