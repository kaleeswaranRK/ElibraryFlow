...
public class SelectionMenu extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-07  05:57:16 PM
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("bookName", "eLibrary:one", false, "exact", "Exit", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("authorName", "eLibrary:two", false, "exact", "Exit", grammarInfo, true);
		list.add(choice);
