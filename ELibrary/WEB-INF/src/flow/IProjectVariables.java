...
public interface IProjectVariables {
	 ...
	 * Last generated by Orchestration Designer at: 2023-JAN-04  12:31:46 PM
	 */
	public static final String UNTITLED_MENU_2 = "untitledMenu2";
	public static final String PASSWORD = "password";
	public static final String UNTITLED_MENU_1 = "untitledMenu1";
	public static final String CATEGORY_MENU_RETURN = "CategoryMenuReturn";
	public static final String OLDUSER_RETURN = "olduserReturn";
	...
	public static final String NEW_USER_RETURN = "newUserReturn";
	public static final String SELECTION_MENU = "SelectionMenu";
	public static final String DATE = "date";
	public static final String JKROWLING_MENU = "JKRowlingMenu";
	public static final String AUTHORSELECTION_RETURN = "authorselectionReturn";
	public static final String CATEGORY_SELECTION_RETURN = "categorySelectionReturn";
	...
	public static final String LANG_RETURN = "langReturn";
	public static final String SESSION = "session";
	public static final String USER_MENU = "userMenu";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String SELECT_AUTHOR_RETURN = "selectAuthorReturn";
	public static final String AUTHOR_MENU = "authorMenu";
	public static final String TIME = "time";
	public static final String SHAREDUUI = "shareduui";
	//}}END:PROJECT:VARIABLES
	//{{START:PROJECT:VARIABLEFIELDS
	public static final String UNTITLED_MENU_2_FIELD_CONFIDENCE = "confidence";
	public static final String UNTITLED_MENU_2_FIELD_INPUTMODE = "inputmode";
	public static final String UNTITLED_MENU_2_FIELD_INTERPRETATION = "interpretation";
	public static final String UNTITLED_MENU_2_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String UNTITLED_MENU_2_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String UNTITLED_MENU_2_FIELD_UTTERANCE = "utterance";
	public static final String UNTITLED_MENU_2_FIELD_VALUE = "value";
	...
	public static final String CATEGORY_MENU_RETURN_FIELD_CONFIDENCE = "confidence";
	public static final String CATEGORY_MENU_RETURN_FIELD_INPUTMODE = "inputmode";
	public static final String CATEGORY_MENU_RETURN_FIELD_INTERPRETATION = "interpretation";
	public static final String CATEGORY_MENU_RETURN_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String CATEGORY_MENU_RETURN_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String CATEGORY_MENU_RETURN_FIELD_UTTERANCE = "utterance";
	public static final String CATEGORY_MENU_RETURN_FIELD_VALUE = "value";
	public static final String OLDUSER_RETURN_FIELD_CONFIDENCE = "confidence";
	public static final String OLDUSER_RETURN_FIELD_INPUTMODE = "inputmode";
	public static final String OLDUSER_RETURN_FIELD_INTERPRETATION = "interpretation";
	public static final String OLDUSER_RETURN_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String OLDUSER_RETURN_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String OLDUSER_RETURN_FIELD_UTTERANCE = "utterance";
	public static final String OLDUSER_RETURN_FIELD_VALUE = "value";
	...
	public static final String E_LIBRARY_FIELD_PASSWORD = "password";
	...
	public static final String NEW_USER_RETURN_FIELD_CONFIDENCE = "confidence";
	public static final String NEW_USER_RETURN_FIELD_INPUTMODE = "inputmode";
	public static final String NEW_USER_RETURN_FIELD_INTERPRETATION = "interpretation";
	public static final String NEW_USER_RETURN_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String NEW_USER_RETURN_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String NEW_USER_RETURN_FIELD_UTTERANCE = "utterance";
	public static final String NEW_USER_RETURN_FIELD_VALUE = "value";
	public static final String SELECTION_MENU_FIELD_CONFIDENCE = "confidence";
	public static final String SELECTION_MENU_FIELD_INPUTMODE = "inputmode";
	public static final String SELECTION_MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String SELECTION_MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String SELECTION_MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String SELECTION_MENU_FIELD_UTTERANCE = "utterance";
	public static final String SELECTION_MENU_FIELD_VALUE = "value";
	...
	public static final String JKROWLING_MENU_FIELD_CONFIDENCE = "confidence";
	public static final String JKROWLING_MENU_FIELD_INPUTMODE = "inputmode";
	public static final String JKROWLING_MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String JKROWLING_MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String JKROWLING_MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String JKROWLING_MENU_FIELD_UTTERANCE = "utterance";
	public static final String JKROWLING_MENU_FIELD_VALUE = "value";
	public static final String AUTHORSELECTION_RETURN_FIELD_CONFIDENCE = "confidence";
	public static final String AUTHORSELECTION_RETURN_FIELD_INPUTMODE = "inputmode";
	public static final String AUTHORSELECTION_RETURN_FIELD_INTERPRETATION = "interpretation";
	public static final String AUTHORSELECTION_RETURN_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String AUTHORSELECTION_RETURN_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String AUTHORSELECTION_RETURN_FIELD_UTTERANCE = "utterance";
	public static final String AUTHORSELECTION_RETURN_FIELD_VALUE = "value";
	public static final String CATEGORY_SELECTION_RETURN_FIELD_CONFIDENCE = "confidence";
	public static final String CATEGORY_SELECTION_RETURN_FIELD_INPUTMODE = "inputmode";
	public static final String CATEGORY_SELECTION_RETURN_FIELD_INTERPRETATION = "interpretation";
	public static final String CATEGORY_SELECTION_RETURN_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String CATEGORY_SELECTION_RETURN_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String CATEGORY_SELECTION_RETURN_FIELD_UTTERANCE = "utterance";
	public static final String CATEGORY_SELECTION_RETURN_FIELD_VALUE = "value";
	...
	public static final String LANG_RETURN_FIELD_CONFIDENCE = "confidence";
	public static final String LANG_RETURN_FIELD_INPUTMODE = "inputmode";
	public static final String LANG_RETURN_FIELD_INTERPRETATION = "interpretation";
	public static final String LANG_RETURN_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String LANG_RETURN_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String LANG_RETURN_FIELD_UTTERANCE = "utterance";
	public static final String LANG_RETURN_FIELD_VALUE = "value";
	...
	public static final String SELECT_AUTHOR_RETURN_FIELD_CONFIDENCE = "confidence";
	public static final String SELECT_AUTHOR_RETURN_FIELD_INPUTMODE = "inputmode";
	public static final String SELECT_AUTHOR_RETURN_FIELD_INTERPRETATION = "interpretation";
	public static final String SELECT_AUTHOR_RETURN_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String SELECT_AUTHOR_RETURN_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String SELECT_AUTHOR_RETURN_FIELD_UTTERANCE = "utterance";
	public static final String SELECT_AUTHOR_RETURN_FIELD_VALUE = "value";
	public static final String AUTHOR_MENU_FIELD_CONFIDENCE = "confidence";
	public static final String AUTHOR_MENU_FIELD_INPUTMODE = "inputmode";
	public static final String AUTHOR_MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String AUTHOR_MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String AUTHOR_MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String AUTHOR_MENU_FIELD_UTTERANCE = "utterance";
	public static final String AUTHOR_MENU_FIELD_VALUE = "value";
