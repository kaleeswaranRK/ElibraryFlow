...
public class langMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Tamil", "1", true, "exact", "tamilAnnounce", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("English", "2", true, "exact", "englishAnnounce", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Hindi", "3", true, "exact", "hindiAnnounce", grammarInfo, true);
		list.add(choice);
