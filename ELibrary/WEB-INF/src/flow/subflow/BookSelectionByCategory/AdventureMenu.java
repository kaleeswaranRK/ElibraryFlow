 ...
 */
public class AdventureMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("The Little Prince", "1", true, "exact", "BookSelectionByCategory-AventureMenuSelectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("A History of Adventure", "2", true, "exact", "BookSelectionByCategory-AventureMenuSelectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("The Alchemist", "3", true, "exact", "BookSelectionByCategory-AventureMenuSelectedBook", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("AdventureMenu", ""));
