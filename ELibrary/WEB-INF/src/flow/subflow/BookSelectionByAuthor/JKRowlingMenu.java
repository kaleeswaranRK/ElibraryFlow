 ...
 * Last generated by Orchestration Designer at: 2023-JAN-03  12:36:45 PM
 */
public class JKRowlingMenu extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2023-JAN-04  12:23:52 PM
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("BookSelectionByAuthor-NoInputDataPassword", 2, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("BookSelectionByAuthor-NoMatchDataPassword", 2, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Harry Potter and the Philosophers Stone", "1", true, "exact", "BookSelectionByAuthor-JKRowlingMenuSelectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Harry Potter and the Chamber of Secrets", "2", true, "exact", "BookSelectionByAuthor-JKRowlingMenuSelectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice(" Harry Potter and the Prisoner of Azkaban", "3", true, "exact", "BookSelectionByAuthor-JKRowlingMenuSelectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("The Little Prince", "4", true, "exact", "BookSelectionByAuthor-JKRowlingMenuSelectedBook", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("JKRowlingBooks", ""));
