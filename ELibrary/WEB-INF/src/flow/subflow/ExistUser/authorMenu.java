...
public class authorMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Jhumpa Lahiri", "1", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("R. Giridharan", "2", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Priyanka Chopra Jonas", "3", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Ashwiny Iyer Tiwari", "4", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Olga Tokarczuk", "5", true, "exact", "ExistUser-selectedAuthor", grammarInfo, true);
		list.add(choice);
