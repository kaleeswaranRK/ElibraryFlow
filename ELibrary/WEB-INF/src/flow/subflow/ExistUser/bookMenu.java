 ...
 * Last generated by Orchestration Designer at: 2022-DEC-07  06:12:48 PM
 */
public class bookMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Whereabouts book", "1", true, "exact", "ExistUser-selectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Under Our Nose book", "2", true, "exact", "ExistUser-selectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Unfinished book", "3", true, "exact", "ExistUser-selectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Mapping Love book", "4", true, "exact", "ExistUser-selectedBook", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("The Lost Soul book", "5", true, "exact", "ExistUser-selectedBook", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("bookMenu", ""));
