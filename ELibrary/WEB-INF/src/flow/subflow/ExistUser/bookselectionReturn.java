 ...
 */
public class bookselectionReturn extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("continue", "1", true, "exact", "ExistUser-bookMenu", grammarInfo, true);
		list.add(choice);
