...
public class AppRoot extends com.avaya.sce.runtime.Root {
	 ...
	 * Last generated by Orchestration Designer at: 2022-DEC-13  12:32:34 PM
	...
	public java.util.Collection getLinks(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		link = new com.avaya.sce.runtime.Link("callEnd", "Exit", null, "00", true, grammarInfo, true, captureExpr);
		list.add(link);
		...
		link = new com.avaya.sce.runtime.Link("subflow", "ExistUser", null, "#", true, grammarInfo, true, captureExpr);
		list.add(link);
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		eventPromptNames.add(new com.avaya.sce.runtime.PromptRefInfo("userNameIssue", ""));

		event = new com.avaya.sce.runtime.Event("nomatchUserId", (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("Exit", 1, true, ""));
		list.add(event);

		// build the list of prompt names
		eventPromptNames = new java.util.ArrayList(1);
		
		eventPromptNames.add(new com.avaya.sce.runtime.PromptRefInfo("passwordIssue", ""));

		event = new com.avaya.sce.runtime.Event("nomatchPassword", (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("Exit", 1, true, ""));
		list.add(event);
		return(list);
	}
}
